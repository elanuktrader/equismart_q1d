DROP FUNCTION IF EXISTS compute_cm_summary(mov_avg_span integer, stock_symbols TEXT[],fetch_date date, insert_date date);
...
BEGIN
    ...
    WITH feature_data AS (
        SELECT * 
        FROM compute_cm_features(mov_avg_span, stock_symbols,fetch_date)
...
DROP FUNCTION IF EXISTS compute_cm_features(integer, TEXT[],date);
