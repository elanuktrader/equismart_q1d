...
def run_main_sql(script_path):
    ...
    output_csv = 'c:/Users/elan4/OneDrive/Documents/GitHub/equismart/test_output/test_results_ABB.csv'
...
if __name__ == "__main__":
    load_sql_functions('c:/Users/elan4/OneDrive/Documents/GitHub/equismart/sql_scripts/production/cm_sql_functions.sql')
    print("----computation start Timestamp:", pd.Timestamp.now())
    start_time = pd.Timestamp.now()
    run_main_sql('c:/Users/elan4/OneDrive/Documents/GitHub/equismart/sql_scripts/testing/volume_data_processing_tester.sql')
    end_time = pd.Timestamp.now() 
    print("----computation Finish Timestamp:", pd.Timestamp.now())
    print('Total Time taken for the execution is:',(end_time-start_time))
    # 