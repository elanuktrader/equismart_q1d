...
if __name__ == "__main__":
    ...
    yaml_config_path = 'c:/Users/elan4/OneDrive/Documents/GitHub/equismart/config/feature_config/complete_summary_generation.yaml'  # Path to your YAML config
    process_summary_yaml(yaml_config_path)
